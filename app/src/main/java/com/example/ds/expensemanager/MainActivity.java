package com.example.ds.expensemanager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aBottomBar.setOnMenuTabClickListener(new OnMenuTabClickListener(){
            ...
            public void onMenuTabSelected(@IdRes int menuItemId) {
                ...
                if (menuItemId == R.id.BottomProfile){
                ...
                else if (menuItemId == R.id.BottomHome){
                    HomeFragment f = new HomeFragment();
                    getFragmentManager().beginTransaction().replace(R.id.frame,f).commit();
                }
                else if (menuItemId == R.id.Bottombudget){
        ...
        aBottomBar.mapColorForTab(3,"#C18C8C");
